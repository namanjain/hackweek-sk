...
import models.LSAccessTokenResponse;
import spark.ModelAndView;
import spark.Request;
import spark.Response;
import spark.TemplateViewRoute;

public class LSCallback implements TemplateViewRoute {
  ...
  private String getAccessToken(String temporaryCode) throws IOException {
    ...
    LSAccessTokenResponse resp = mapper.readValue(respString, LSAccessTokenResponse.class);
